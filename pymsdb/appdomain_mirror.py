...
class AppDomainMirror:
    ...
    def __str__(self):
        return "AppDomain Mirror, name = {0}".format(self.get_name())
    ...
    def get_entry_assembly(self):
        if self._entry_assembly_id is None:
            ...
            self._entry_assembly_id = BufferStream(answer.data).get_int()
    ...
    def get_corlib_assembly(self):
        if self._corlib_assembly_id is None:
            ...
            self._corlib_assembly_id = BufferStream(answer.data).get_int()
