...
class ObjectMirror:
    ...
    def get_type(self):
        if self._type_id is None:
            ...
            self._type_id = BufferStream(answer.data).get_int()
    ...
    def get_appdomain(self):
        if self._appdomain_id is None:
            ...
            self._appdomain_id = BufferStream(answer.data).get_int()
    ...
    def get_is_collected(self):
        ...
        is_collected = (BufferStream(answer.data).get_int() == 1)
        return is_collected
    ...
    def get_address(self):
        if self._address is None:
            ...
            self._address = BufferStream(answer.data).get_long()
    ...
    def get_string_value(self):
        if self._string_value is None:
            ...
            self._string_value = BufferStream(answer.data).get_string()
